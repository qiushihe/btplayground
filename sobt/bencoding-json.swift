...
extension Sobt.Bencoding {
  struct Json {
    ...
    static func bEncodedToJsonString(encoded: BEncoded, _ level: Int, _ noIndent: Bool, _ withNewLine: Bool) -> String {
      switch encoded {
    ...
    static func bEncodedToJsonString(encoded: BEncoded) -> String {
      return bEncodedToJsonString(encoded, 0, false, true);
    }
    
    static func bEncodedToJsonObject(encoded: BEncoded) -> NSDictionary? {
      do {
